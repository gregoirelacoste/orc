...
- **CODEBASE.md** est-il à jour ? Y a-t-il des modules non documentés ?
...
- CODEBASE.md : vérifier que l'inventaire reflète le code réel, supprimer les entrées obsolètes
